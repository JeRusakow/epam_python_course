...
def gen_symbols_from_file(filename: str, encoding="utf-8") -> Generator:
    """Generator for reading a file symbol by symbol"""
...
def get_rarest_char(file_path: str) -> str:
    ...
    for symbol in gen_symbols_from_file(file_path, encoding="unicode-escape"):
